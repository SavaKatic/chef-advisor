...
describe('Service Tests', () => {
  describe('UnitType Service', () => {
    ...
    let expectedResult: IUnitType | IUnitType[] | boolean | null;
    ...
    describe('Service methods', () => {
      ...
      it('should create a UnitType', () => {
        ...
        service.create(new UnitType()).subscribe(resp => (expectedResult = resp.body));
