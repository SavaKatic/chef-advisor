...
import { IngredientTypeComponent } from 'app/entities/ingredient-type/ingredient-type.component';
...
describe('Component Tests', () => {
  describe('IngredientType Management Component', () => {
    let comp: IngredientTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(IngredientTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ingredientTypes && comp.ingredientTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
