...
import { DishTypeComponent } from 'app/entities/dish-type/dish-type.component';
...
describe('Component Tests', () => {
  describe('DishType Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dishTypes && comp.dishTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
